...
// You may use this file to debug, understand or extend dear_imgui features but we don't provide any guarantee of forward compatibility.
...
struct ImGuiContext;                // Main dear_imgui context
...
enum ImGuiInputFlags_
{
    ...
    ImGuiInputFlags_RouteUnlessBgFocused= 1 << 17,  // Global routes will not be applied if underlying background/void is focused (== no dear_imgui windows are focused). Useful for overlay applications.
...
//-----------------------------------------------------------------------------
// [SECTION] ImGuiContext (main dear_imgui context)
//-----------------------------------------------------------------------------
...
namespace ImGui
{
    ...
    IMGUI_API ImDrawList*   GetBackgroundDrawList(ImGuiViewport* viewport);                     // get background draw list for the given viewport. this draw list will be the first rendering one. Useful to quickly draw shapes/text behind dear_imgui contents.
    IMGUI_API ImDrawList*   GetForegroundDrawList(ImGuiViewport* viewport);                     // get foreground draw list for the given viewport. this draw list will be the last rendered one. Useful to quickly draw shapes/text over dear_imgui contents.
