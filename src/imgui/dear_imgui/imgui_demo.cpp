...
// - Need help integrating dear_imgui in your codebase?
//   - Read Getting Started https://github.com/ocornut/imgui/wiki/Getting-Started
//   - Read 'Programmer guide' in imgui.cpp for notes on how to setup dear_imgui in your codebase.
...
//---------------------------------------------------
// Message to the person tempted to delete this file when integrating dear_imgui into their codebase:
...
// If you want to link core dear_imgui in your shipped builds but want a thorough guarantee that the demo will not be
// linked, you can setup your imconfig.h with #define IMGUI_DISABLE_DEMO_WINDOWS and those functions will be empty.
// In another situation, whenever you have dear_imgui available you probably want this to be available for reference.
// Thank you,
...
// - We never use any of the helpers/facilities used internally by dear_imgui, unless available in the public API.
...
// Demonstrate most dear_imgui features (this is big function!)
// You may execute this function to experiment with the UI and understand what it does.
// You may then search for keywords in the code when you are interested by a specific feature.
void ImGui::ShowDemoWindow(bool* p_open)
{
    // Exceptionally add an extra assert here for people confused about initial dear_imgui setup
    // Most functions would normally just assert/crash if the context is missing.
    IM_ASSERT(ImGui::GetCurrentContext() != NULL && "Missing dear_imgui context. Refer to examples app!");
    ...
    // dear_imgui Tools (accessible from the "Tools" menu)
    ...
    {
        ImGui::Begin("dear_imgui Style Editor", &show_tool_style_editor);
    ...
    if (!ImGui::Begin("dear_imgui Demo", p_open, window_flags))
    {
    ...
    if (ImGui::BeginMenuBar())
    {
        ...
        if (ImGui::BeginMenu("Tools"))
        {
            ...
            ImGui::MenuItem("About dear_imgui", NULL, &show_tool_about);
            ImGui::EndMenu();
        }
        ImGui::EndMenuBar();
    }

    ImGui::Text("dear_imgui says hello! (%s) (%d)", IMGUI_VERSION, IMGUI_VERSION_NUM);
    ImGui::Spacing();
    ...
    if (ImGui::CollapsingHeader("Help"))
    {
        ...
        ImGui::BulletText("The \"Tools\" menu above gives access to: About Box, Style Editor,\n"
                          "and Metrics/Debugger (general purpose dear_imgui debugging tool).");
    ...
    if (ImGui::CollapsingHeader("Configuration"))
    {
        ...
        if (ImGui::TreeNode("Configuration##2"))
        {
            ...
            ImGui::SameLine(); HelpMarker("Instruct dear_imgui to render a mouse cursor itself. Note that a mouse cursor rendered via your application GPU rendering path will feel more laggy than hardware cursor, but will be more in sync with your other visuals.\n\nSome desktop applications may use both kinds of cursors (e.g. enable software cursor only when resizing/dragging something).");
...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Data Types"))
    {
        ...
        ImGui::SameLine(); HelpMarker(
            "As with every widget in dear_imgui, we never modify values unless there is a user interaction.\n"
...
static void ShowDemoWindowPopups()
{
    ...
    // - Their visibility state (~bool) is held internally by dear_imgui instead of being held by the programmer as
...
struct MyItem
{
    ...
    // As we don't rely on std:: or other third-party library to compile dear_imgui, we only have reliable access to qsort(),
...
static void ShowDemoWindowInputs()
{
    ...
    if (ImGui::CollapsingHeader("Inputs & Focus"))
    {
        ...
        {
            HelpMarker(
                "The value of io.WantCaptureMouse and io.WantCaptureKeyboard are normally set by dear_imgui "
                "to instruct your application of how to route inputs. Typically, when a value is true, it means "
                "dear_imgui wants the corresponding inputs and we expect the underlying application to ignore them.\n\n"
                "The most typical case is: when hovering a window, dear_imgui set io.WantCaptureMouse to true, "
...
//-----------------------------------------------------------------------------
// [SECTION] About Window / ShowAboutWindow()
// Access from dear_imgui Demo -> Tools -> About
//-----------------------------------------------------------------------------

void ImGui::ShowAboutWindow(bool* p_open)
{
    if (!ImGui::Begin("About dear_imgui", p_open, ImGuiWindowFlags_AlwaysAutoResize))
    {
        ImGui::End();
        return;
    }
    IMGUI_DEMO_MARKER("Tools/About dear_imgui");
    ImGui::Text("dear_imgui %s (%d)", IMGUI_VERSION, IMGUI_VERSION_NUM);
    ImGui::Separator();
    ImGui::Text("By Omar Cornut and all dear_imgui contributors.");
    ImGui::Text("dear_imgui is licensed under the MIT License, see LICENSE for more information.");
...
static void ShowExampleAppCustomRendering(bool* p_open)
{
    ...
    // types and ImVec2/ImVec4. dear_imgui defines overloaded operators but they are internal to imgui.cpp and not
    ...
    if (ImGui::BeginTabBar("##TabBar"))
    {
        ...
        if (ImGui::BeginTabItem("BG/FG draw lists"))
        {
            ...
            ImGui::SameLine(); HelpMarker("The Background draw list will be rendered below every dear_imgui windows.");
            ImGui::Checkbox("Draw in Foreground draw list", &draw_fg);
            ImGui::SameLine(); HelpMarker("The Foreground draw list will be rendered over every dear_imgui windows.");
