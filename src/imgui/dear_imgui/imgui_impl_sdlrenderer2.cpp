// dear_imgui: Renderer Backend for SDL_Renderer for SDL2
// (Requires: SDL 2.0.17+)
...
// Backend data stored in io.BackendRendererUserData to allow support for multiple dear_imgui contexts
