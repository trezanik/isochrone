...
#define TZK_CVAR_SETTING_CONFIG_SAVE_ON_EXIT            "config.save_on_exit"
...
// HASHES
/////////////
#define TZK_CVAR_HASH_AUDIO_AMBIENT_TRACK_ENABLED        TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_AUDIO_AMBIENT_TRACK_ENABLED)
#define TZK_CVAR_HASH_AUDIO_AMBIENT_TRACK_NAME           TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_AUDIO_AMBIENT_TRACK_NAME)
#define TZK_CVAR_HASH_AUDIO_FX_APPERROR_ENABLED          TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_AUDIO_FX_APPERROR_ENABLED)
#define TZK_CVAR_HASH_AUDIO_FX_APPERROR_NAME             TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_AUDIO_FX_APPERROR_NAME)
#define TZK_CVAR_HASH_AUDIO_FX_BUTTONSELECT_ENABLED      TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_AUDIO_FX_BUTTONSELECT_ENABLED)
#define TZK_CVAR_HASH_AUDIO_FX_BUTTONSELECT_NAME         TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_AUDIO_FX_BUTTONSELECT_NAME)
#define TZK_CVAR_HASH_AUDIO_FX_RSSNOTIFY_ENABLED         TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_AUDIO_FX_RSSNOTIFY_ENABLED)
#define TZK_CVAR_HASH_AUDIO_FX_RSSNOTIFY_NAME            TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_AUDIO_FX_RSSNOTIFY_NAME)
#define TZK_CVAR_HASH_AUDIO_FX_TASKCOMPLETE_ENABLED      TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_AUDIO_FX_TASKCOMPLETE_ENABLED)
#define TZK_CVAR_HASH_AUDIO_FX_TASKCOMPLETE_NAME         TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_AUDIO_FX_TASKCOMPLETE_NAME)
#define TZK_CVAR_HASH_AUDIO_FX_TASKFAILED_ENABLED        TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_AUDIO_FX_TASKFAILED_ENABLED)
#define TZK_CVAR_HASH_AUDIO_FX_TASKFAILED_NAME           TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_AUDIO_FX_TASKFAILED_NAME)
#define TZK_CVAR_HASH_CONFIG_SAVE_ON_EXIT                TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_CONFIG_SAVE_ON_EXIT)
#define TZK_CVAR_HASH_DATA_SYSINFO_ENABLED               TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_DATA_SYSINFO_ENABLED)
#define TZK_CVAR_HASH_DATA_SYSINFO_MINIMAL               TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_DATA_SYSINFO_MINIMAL)
#define TZK_CVAR_HASH_DATA_TELEMETRY_ENABLED             TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_DATA_TELEMETRY_ENABLED)
#define TZK_CVAR_HASH_LOG_ENABLED                        TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_LOG_ENABLED)
#define TZK_CVAR_HASH_LOG_FILE_ENABLED                   TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_LOG_FILE_ENABLED)
#define TZK_CVAR_HASH_LOG_FILE_FOLDER_PATH               TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_LOG_FILE_FOLDER_PATH)
#define TZK_CVAR_HASH_LOG_FILE_NAME_FORMAT               TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_LOG_FILE_NAME_FORMAT)
...
#define TZK_CVAR_HASH_RSS_FEEDS                          TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_RSS_FEEDS)
#define TZK_CVAR_HASH_UI_DEFAULT_FONT_FILE               TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_DEFAULT_FONT_FILE)
#define TZK_CVAR_HASH_UI_DEFAULT_FONT_SIZE               TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_DEFAULT_FONT_SIZE)
#define TZK_CVAR_HASH_UI_FIXED_WIDTH_FONT_FILE           TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_FIXED_WIDTH_FONT_FILE)
#define TZK_CVAR_HASH_UI_FIXED_WIDTH_FONT_SIZE           TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_FIXED_WIDTH_FONT_SIZE)
#define TZK_CVAR_HASH_UI_LAYOUT_BOTTOM_EXTEND            TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_LAYOUT_BOTTOM_EXTEND)
#define TZK_CVAR_HASH_UI_LAYOUT_BOTTOM_RATIO             TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_LAYOUT_BOTTOM_RATIO)
//#define TZK_CVAR_HASH_UI_LAYOUT_CONSOLE_LOCATION         TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_LAYOUT_CONSOLE_LOCATION)
#define TZK_CVAR_HASH_UI_LAYOUT_LEFT_EXTEND              TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_LAYOUT_LEFT_EXTEND)
#define TZK_CVAR_HASH_UI_LAYOUT_LEFT_RATIO               TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_LAYOUT_LEFT_RATIO)
#define TZK_CVAR_HASH_UI_LAYOUT_LOG_LOCATION             TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_LAYOUT_LOG_LOCATION)
#define TZK_CVAR_HASH_UI_LAYOUT_RIGHT_EXTEND             TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_LAYOUT_RIGHT_EXTEND)
#define TZK_CVAR_HASH_UI_LAYOUT_RIGHT_RATIO              TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_LAYOUT_RIGHT_RATIO)
//#define TZK_CVAR_HASH_UI_LAYOUT_RSS_LOCATION             TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_LAYOUT_RSS_LOCATION)
#define TZK_CVAR_HASH_UI_LAYOUT_TOP_EXTEND               TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_LAYOUT_TOP_EXTEND)
#define TZK_CVAR_HASH_UI_LAYOUT_TOP_RATIO                TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_LAYOUT_TOP_RATIO)
#define TZK_CVAR_HASH_UI_LAYOUT_UNFIXED                  TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_LAYOUT_UNFIXED)
//#define TZK_CVAR_HASH_UI_LAYOUT_VKBD_LOCATION            TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_LAYOUT_VKBD_LOCATION)
#define TZK_CVAR_HASH_UI_PAUSE_ON_FOCUS_LOSS_ENABLED     TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_PAUSE_ON_FOCUS_LOSS_ENABLED)
#define TZK_CVAR_HASH_UI_SDL_RENDERER_TYPE               TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_SDL_RENDERER_TYPE)
#define TZK_CVAR_HASH_UI_STYLE_NAME                      TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_STYLE_NAME)
#define TZK_CVAR_HASH_UI_TERMINAL_ENABLED                TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_TERMINAL_ENABLED)
#define TZK_CVAR_HASH_UI_TERMINAL_POS_X                  TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_TERMINAL_POS_X)
#define TZK_CVAR_HASH_UI_TERMINAL_POS_Y                  TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_TERMINAL_POS_Y)
#define TZK_CVAR_HASH_UI_WINDOW_ATTR_FULLSCREEN          TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_WINDOW_ATTR_FULLSCREEN)
#define TZK_CVAR_HASH_UI_WINDOW_ATTR_MAXIMIZED           TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_WINDOW_ATTR_MAXIMIZED)
#define TZK_CVAR_HASH_UI_WINDOW_ATTR_WINDOWEDFULLSCREEN  TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_WINDOW_ATTR_WINDOWEDFULLSCREEN)
#define TZK_CVAR_HASH_UI_WINDOW_DIMENSIONS_HEIGHT        TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_WINDOW_DIMENSIONS_HEIGHT)
#define TZK_CVAR_HASH_UI_WINDOW_DIMENSIONS_WIDTH         TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_WINDOW_DIMENSIONS_WIDTH)
#define TZK_CVAR_HASH_UI_WINDOW_POS_DISPLAY              TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_WINDOW_POS_DISPLAY)
#define TZK_CVAR_HASH_UI_WINDOW_POS_X                    TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_WINDOW_POS_X)
#define TZK_CVAR_HASH_UI_WINDOW_POS_Y                    TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_UI_WINDOW_POS_Y)
#define TZK_CVAR_HASH_WORKSPACES_PATH                    TZK_COMPILE_TIME_HASH(TZK_CVAR_SETTING_WORKSPACES_PATH)
...
#define TZK_CVAR_DEFAULT_CONFIG_SAVE_ON_EXIT             "true"
