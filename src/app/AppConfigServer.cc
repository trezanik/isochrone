...
)
{
	...
	case TZK_CVAR_HASH_UI_LAYOUT_TOP_RATIO:
		...
		return ErrNONE;
	case TZK_CVAR_HASH_UI_LAYOUT_CANVASDBG_LOCATION:
	case TZK_CVAR_HASH_UI_LAYOUT_LOG_LOCATION:
	case TZK_CVAR_HASH_UI_LAYOUT_PROPERTIES_LOCATION:
		{
