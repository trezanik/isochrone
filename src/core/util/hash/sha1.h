...
/**
 * @file        src/core/util/hash/sha1.h
 * @brief       Simple SHA1 hash generator
...
constexpr size_t  sha1_hash_size = 20;  // (160-bit, 20 bytes)
constexpr size_t  sha1_string_length = 40;
constexpr size_t  sha1_string_buffer_size = sha1_string_length + 1;


/**
 * Calculates the SHA1 of a pre-populated buffer
 *
 * @param[in] buffer
...
/**
 * Calculates the SHA1 of a specified file
 *
...
/**
 * Calculates the SHA1 of an existing file stream
 *
...
/**
 * Takes a SHA1 digest and converts it to its textual representation
 *
 * @param[in] digest
 *  The SHA1 digest
