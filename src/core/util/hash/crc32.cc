/**
 * @file        src/core/util/hash/crc32.cc
...
)
{
	...
	rc = crc32_of_filestream(fp, checksum);
...
{
	if ( out_string == nullptr || buf_count < crc32_string_buffer_size )
		return EINVAL;

	sprintf(out_string, "%08x", checksum);
	out_string[crc32_string_length] = '\0';
