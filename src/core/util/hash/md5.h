...
/**
 * @file        src/core/util/hash/md5.h
 * @brief       Simple MD5 hash generator
...
constexpr size_t  md5_hash_size = 16;  // (128-bit, 16 bytes)
constexpr size_t  md5_string_length = 32;
constexpr size_t  md5_string_buffer_size = md5_string_length + 1;


/**
 * Calculates the MD5 of a pre-populated buffer
 *
 * @param[in] buffer
...
/**
 * Calculates the MD5 of a specified file
 *
...
/**
 * Calculates the MD5 of an existing file stream
 *
...
/**
 * Takes a MD5 digest and converts it to its textual representation
 *
 * @param[in] digest
 *  The MD5 digest
